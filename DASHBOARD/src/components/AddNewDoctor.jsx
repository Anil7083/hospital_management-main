...
const AddNewDoctor = () => {
    ...
    const handleAddNewDoctor = async (e) => {
        ...
        try {
            ...
            formData.append("doctorsDepartment", doctorsDepartment);
            formData.append("docAvatar", docAvatar);
            formData.append("dob", dob);


            const response = await axios.post("https://hospital-management-main-1xbz.onrender.com/api/v1/user/doctor/addnew",
                formData,
                {
                    ...
                    <form onSubmit={handleAddNewDoctor}>
                        ...
                        <div className="first-wrapper">
                            ...
                            <div>
                                ...
                                <select value={doctorsDepartment} onChange={(e)=>setDoctorsDepartment(e.target.value)}>
                                ...
                                <button type="submit">Regsiter New Doctor</button>
                            </div>
